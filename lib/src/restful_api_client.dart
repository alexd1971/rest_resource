...
class RestfulApiClient {
  ...
  Future<ApiResponse> get({String resourcePath, Map<String,String> queryParameters}) async {
  ...
  /// 
  /// Возвращает [Future] с [ApiResponse]
  Future<ApiResponse> post({String resourcePath, Map<String,dynamic> body}) async {
    var requestBody;
  ...
  /// 
  /// Возвращает [Future] с [ApiResponse]
  Future<ApiResponse> put({String resourcePath, Map<String,dynamic> body}) async {
  ...
  /// 
  /// Возвращает [Future] с [ApiResponse]
  Future<ApiResponse> patch({String resourcePath, Map<String,dynamic> body}) async {
  ...
  /// 
  /// Возвращает [Future] с [ApiResponse]
  Future<ApiResponse> delete({String resourcePath, Map<String,String> queryParameters}) async {
